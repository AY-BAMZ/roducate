                    ...
                    <span className="flex-grow">
                        <div className="flex flex-col gap-4">
                            ...
                            <p className="text-black-400 text-[14px] font-light max-w-[80%]">
                                ...
                                MORENT App. Morent has a low price and also a
                                large variety of cars with good and comfortable
                                facilities. In addition, the service provided by
                                the officers is also very friendly and very
                                polite.
                            </p>
                        </div>
                    </span>
